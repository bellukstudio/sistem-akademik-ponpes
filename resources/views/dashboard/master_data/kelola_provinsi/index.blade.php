        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('kelolaProvinsi') }}
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="overflow: auto;">
            <div class="card-header">
                ...
                <a href="{{ route('trashProvince') }}" class="btn btn-secondary">
                            ...
                            <form action="{{ route('kelolaProvinsi.store') }}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="province_name" id="" class="form-control"
                                        value="{{ old('province_name') }}" placeholder="Nama Provinsi"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                Close</button>
                                            <form action="{{ route('kelolaProvinsi.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                        ...
                                        <form action="{{ route('kelolaProvinsi.update', $item->id) }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="province_name" id=""
                                                    class="form-control"
                                                    value="{{ old('province_name') ?? $item->province_name }}"
