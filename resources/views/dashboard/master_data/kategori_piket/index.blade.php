...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Kategori Piket</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('kategoriPiket') }}
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="overflow: auto;">
            <div class="card-header">
                ...
                <a href="{{ route('trashPicketCategories') }}" class="btn btn-secondary">
                    <i class="fa fa-trash mr-2"></i>Trash
                    Bin</a>

                {{-- Modal new data --}}
                <div class="modal fade" id="modal-AddData" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('kategoriPiket.store') }}" method="post">
                                @csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="">Nama</label>
                                        <input type="text" name="picket" id="" class="form-control"
                                            value="{{ old('picket') }}" placeholder="Nama Piket"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                Close</button>
                                            <form action="{{ route('kategoriPiket.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                            ...
                            <div class="modal fade" id="modal-Edit{{ $item->id }}">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('kategoriPiket.update', $item->id) }}" method="post"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="">Nama</label>
                                                    <input type="text" name="picket" id=""
                                                        class="form-control" value="{{ old('picket') ?? $item->name }}"
                                                        placeholder="Nama Piket"
                                                        oninput="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="modal-footer justify-content-between">
