...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Kota {{ $city->city_name }}</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('kelolaKota.edit', $city) }}
...
@section('content-section')
    <div class="container-fluid">
        ...
        {{-- form search --}}
        <form class="form-inline" action="{{ route('kelolaKota.edit', $city->id) }}" method="GET">
            @csrf
