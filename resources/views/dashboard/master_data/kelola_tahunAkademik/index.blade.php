        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('manageTahunAkademik') }}
                </ol>
            </div>
            <!-- /.col -->
        </div>
            ...
            <div class="card-header">
                ...
                <div class="modal fade" id="modal-AddData">
                    <div class="modal-dialog">
                        <form action="{{ route('manageTahunAkademik.store') }}" method="post">
                            @csrf
                ...
                <tbody>
                    @forelse ($tahunAkademik as $index => $item)
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">
                                            Close</button>
                                        <form action="{{ route('manageTahunAkademik.destroy', $item->id) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
                        ...
                        <div class="modal fade" id="modal-Edit{{ $item->id }}">
                            <div class="modal-dialog">
                                <form action="{{ route('manageTahunAkademik.update', $item->id) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <label for="">Kode</label>
                                            <input type="text" name="kode" id="" class="form-control"
                                                value="{{ old('kode') ?? $item->kode }}" placeholder="2019/2020">
                                            <label for="">Tanggal Mulai </label>
                                            <input type="date" name="tgl_mulai" id="" class="form-control"
