        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('kelolaRuangan') }}
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('trashRoom') }}" class="btn btn-secondary">
                ...
                <div class="modal fade" id="modal-AddData">
                    <div class="modal-dialog">
                        <form action="{{ route('kelolaRuangan.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" name="room_name" id="" class="form-control"
                                        value="{{ old('room_name') }}" placeholder="Nama Ruangan"
                    ...
                    <tbody>
                        @forelse ($kamar as $index => $item)
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                Close</button>
                                            <form action="{{ route('kelolaRuangan.destroy', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
                            ...
                            <div class="modal fade" id="modal-Edit{{ $item->id }}">
                                <div class="modal-dialog">
                                    <form action="{{ route('kelolaRuangan.update', $item->id) }}" method="post"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="number" name="capasity" id=""
                                                    class="form-control"
                                                    value="{{ old('capasity') ?? $item->capasity }}"
