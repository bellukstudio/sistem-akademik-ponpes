...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Trash Bin (Program Akademik)</h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <a href="{{ route('restoreAllProgram') }}" class="btn btn-sm btn-danger">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <a href="{{ route('deletePermanentAllProgram') }}" class="btn btn-sm btn-danger">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                Close</button>
                                            <a href="{{ route('deletePermanentProgram', $item->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <a href="{{ route('restoreProgram', $item->id) }}"
