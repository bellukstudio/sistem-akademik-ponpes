                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('kelolaAbsen.store') }}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <label for="">Kolom Absen <code>*pisahkan dengan koma (,)</code></label>
                                    <input type="text" name="column_name" id="" class="form-control"
                                        value="{{ old('column') }}" placeholder="No,Nama,Kelas">
                                        ...
                                        <form action="{{ route('kelolaAbsen.update', $item->id) }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="name" id="" class="form-control"
                                                    ...
                                                    oninput="this.value = this.value.toUpperCase()">
                                                <br>
                                                <label for="">Kolom Absen</label>
                                                <input type="text" name="column_name" id=""
                                                    class="form-control"
                                                    value="{{ old('column_name') ?? $item->column }}"
