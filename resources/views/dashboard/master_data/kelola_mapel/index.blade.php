        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{ Breadcrumbs::render('kelolaMapel') }}
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="overflow: auto;">
            <div class="card-header">
                ...
                <a href="{{ route('trashCourse') }}" class="btn btn-secondary">
                ...
                <div class="modal fade" id="modal-AddData">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('kelolaMapel.store') }}" method="post">
                                @csrf
                                <div class="modal-body">
                                    <label for="">Mata Pelajaran</label>
                                    <input type="text" name="course_name" class="form-control"
                                        value="{{ old('course_name') }}" placeholder="Mata Pelajaran"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                Close</button>
                                            <form action="{{ route('kelolaMapel.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                            ...
                            <div class="modal fade" id="modal-Edit{{ $item->id }}">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('kelolaMapel.update', $item->id) }}" method="post">
                                            @csrf
                                            @method('put')
                                            <div class="modal-body">
                                                <label for="">Mata Pelajaran</label>
                                                <input type="text" name="course_name" class="form-control"
                                                    value="{{ old('course_name') ?? $item->course_name }}"
                                                ...
                                                <select name="program" id=""
                                                    ...
                                                    @forelse ($program as $data)
                                                        <option value="{{ $data->id }}"
                                                            {{ $item->program->id == $data->id ? 'selected' : '' }}>
                                                            {{ $data->program_name }}
                                                        </option>
                                                    @empty
                                                        <option value=""></option>
