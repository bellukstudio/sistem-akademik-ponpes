                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="entry_year" id="" class="form-control"
                            value="{{ old('entry_year') }}" placeholder="2019 / 2019/2020">
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="tel" name="parent_phone" id="parent_phone" class="form-control"
                                value="{{ old('parent_phone') }}" placeholder="Nomor Telepon">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="father_name" id="father_name" class="form-control"
                                autocomplete="off" value="{{ old('father_name') }}" placeholder="Nama Ayah">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="student_parent">Nama Ibu</label>
                            <input type="text" name="mother_name" id="mother_name" class="form-control"
                                autocomplete="off" value="{{ old('mother_name') }}" placeholder="Nama Ibu">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="date_birth_father" id="date_birth_father" class="form-control"
                                autocomplete="off" value="{{ old('date_birth_father') }}" placeholder="Tanggal Lahir">
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" name="date_birth_mother" id="date_birth_mother" class="form-control"
                                autocomplete="off" value="{{ old('date_birth_mother') }}" placeholder="Tanggal Lahir">
                        </div>
                    </div>
